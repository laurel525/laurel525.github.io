...
# Is it sweater weather? Using If...then statements to find out!
...
![Debugging output of temp integer 30](https://laurel525.github.io/assets/img/Code-debug-1.png)

### Tip/Hint for my Past Self

I would have advised myself to introduce multiple "if...then" statements from the start. Starting with only one of each required statement felt kind of limiting and made me overthink the parameters I set. Pursuing the extra credit opportunity and adding multiple "if...thens" allowed me to make the program more realistic to account for numerous different weather conditions. It was fun!
